...
func (x *CreatePostRequest) GetCategoryId() uint32 {
	if x != nil {
		return x.CategoryId
	}
	return 0
...
func (x *PostInfo) GetCategoryId() uint32 {
	if x != nil {
		return x.CategoryId
	}
	return 0
...
var file_proto_post_proto_rawDesc = []byte{
	...
	0x9e, 0x01, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x50, 0x6f, 0x73, 0x74, 0x52, 0x65,
	...
	0x01, 0x28, 0x0d, 0x52, 0x0a, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x12,
	...
	0x28, 0x0d, 0x52, 0x05, 0x54, 0x61, 0x67, 0x49, 0x64, 0x22, 0xfd, 0x01, 0x0a, 0x08, 0x50, 0x6f,
	...
	0x07, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x12, 0x1e, 0x0a, 0x0a, 0x43, 0x61, 0x74, 0x65,
	0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x0a, 0x43, 0x61,
	0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x49, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x53, 0x74, 0x61, 0x72,
	...
	0xf2, 0x01, 0x0a, 0x04, 0x50, 0x6f, 0x73, 0x74, 0x12, 0x37, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61,
...
var file_proto_post_proto_depIdxs = []int32{
	7, // 0: post.CreatePostRequest.Tag:type_name -> post.TagInfo
	5, // 1: post.CategoryRequest.category:type_name -> post.CategoryInfo
	5, // 2: post.CategoryResponse.categories:type_name -> post.CategoryInfo
	7, // 3: post.PostInfo.tag:type_name -> post.TagInfo
	8, // 4: post.PostResponse.posts:type_name -> post.PostInfo
	2, // 5: post.Post.CreatePost:input_type -> post.CreatePostRequest
	3, // 6: post.Post.DeletePost:input_type -> post.DeletePostRequest
	0, // 7: post.Post.GetCategory:input_type -> post.Request
	4, // 8: post.Post.GetPostOfCategory:input_type -> post.CategoryRequest
	1, // 9: post.Post.CreatePost:output_type -> post.Response
	1, // 10: post.Post.DeletePost:output_type -> post.Response
	6, // 11: post.Post.GetCategory:output_type -> post.CategoryResponse
	9, // 12: post.Post.GetPostOfCategory:output_type -> post.PostResponse
